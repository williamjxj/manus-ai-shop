    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t pt-4">
            <div className="flex justify-between text-lg font-semibold">
              ...
              <div className="text-right">
                ...
                <div className="text-sm text-indigo-600">or {getTotalPoints()} points</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-4">
            ...
            <label className="flex items-center">
              ...
              <div className="ml-3 flex items-center">
                ...
                <span className={`text-sm font-medium ${canUsePoints ? 'text-gray-900' : 'text-gray-400'}`}>
            ...
            {!canUsePoints && paymentMethod === 'points' && (
              <p className="text-sm text-red-600 ml-7">
                Insufficient points. You need {getTotalPoints()} points but only have {profile?.points || 0}.
              </p>
            )}
          </div>
        </div>
        ...
        <div className="flex space-x-4">
          <Link
            href="/cart"
            className="flex-1 flex items-center justify-center px-6 py-3 border border-gray-300 text-base font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50"
          >
            <ArrowLeft className="h-4 w-4 mr-2" />
            Back to Cart
          </Link>
          ...
          <button
            ...
            disabled={processing || (paymentMethod === 'points' && !canUsePoints)}
            className="flex-1 flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {processing ? (
